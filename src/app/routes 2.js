...
//             user(userModel, $http, pmcw, secureSessionStorage) {
//                 if (Object.keys(userModel.get()).length > 0) {
...
//                 }
//
//                 return userModel.load(); // TODO need to rework this just for the locked page
//             },
...
//         url: '/contacts',
//         resolve: {
//             delinquent($state, gettextCatalog, user, notify, userModel) {
//                 if (userModel.get().Delinquent >= 3) {
...
//         const stateName = $injector.get('userModel').state() || 'secured.inbox';
//
