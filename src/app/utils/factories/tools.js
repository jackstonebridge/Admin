...
// .factory('tools', ($log, $state, $stateParams, $filter, userModel, $compile, $templateCache, $rootScope, $q, CONSTANTS) => {
//     const tools = {};
//
...
//
//         if (userModel.get().ViewMode === CONSTANTS.MESSAGE_VIEW_MODE || specialBoxes.indexOf(box) > -1) {
//             return 'message';
//         }
//
//         return 'conversation';
...
//
//     tools.typeView = () => {
//         return (userModel.get().ViewMode === CONSTANTS.MESSAGE_VIEW_MODE) ? 'message' : 'conversation';
//     };
//
//     /**
