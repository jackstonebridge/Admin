...
//                 }
//
//                 const mailboxPassword = userModel.getPassword();
//
//                 if (user.Role === 0) {
...
//                                 const index = _.findIndex(userModel.get().Addresses, { ID: address.ID });
//
//                                 if (index === -1) {
//                                     userModel.get().Addresses.push(address);
//                                     $rootScope.$broadcast('createUser');
//                                 } else {
//                                     angular.extend(userModel.get().Addresses[index], address);
//                                 }
//                             });
//
//                             let index = userModel.get().Addresses.length;
//
//                             while (index--) {
//                                 const address = userModel.get().Addresses[index];
//                                 const found = _.findWhere(user.Addresses, { ID: address.ID });
//
//                                 if (angular.isUndefined(found)) {
//                                     userModel.get().Addresses.splice(index, 1);
//                                 }
//                             }
//                         } else {
//                             userModel.get()[key] = user[key];
//                         }
//                     });
//                     angular.extend($rootScope.user, userModel.get());
...
//                             .then(() => Promise.reject(), () => userKeysModel.store(keys));
//                         }
//                         userKeysModel.store(keys);
//                     })
//                     .then(mergeUser);
//
//             },
...
//                         .concat(_.map(userModel.get().Labels || [], ({ ID }) => ID));
//
...
//                     userModel.get().UsedSpace = storage;
//                 }
//             },
