...
.factory('Message', (
    ...
    _.extend(Message.prototype, {
        ...
        encryptBody(pubKey) {
            ...
            const privKey = userKeysModel.getPrivates(this.From.ID);
         ...
         */
        decryptBody() {
            const privKey = userKeysModel.getPrivates(this.AddressID);
            let pubKeys = null;
        ...
        clearPackets() {
            ...
            const promises = [];
            const deferred = $q.defer();
            const keys = userKeysModel.getPrivates(this.AddressID);
